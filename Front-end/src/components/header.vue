<template>
  ...
  <nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <a href="#" class="flex items-center">
        <img src="@/assets/images/logo.png" class="mr-3 sm:h-14" alt="Flowbite Logo">
    </a>
    <div class="flex md:order-2">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
          ...
          <ul class="py-2" aria-labelledby="user-menu-button">
            <li>
              <RouterLink to="/mesReservations"><a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Mes resérvations</a></RouterLink>
            </li>
            <li>
